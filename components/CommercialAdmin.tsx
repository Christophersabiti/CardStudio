      ...
      <div className="grid lg:grid-cols-2 gap-5">
        ...
        >
          ...
          <fieldset disabled={busy} className="grid gap-4">
            ...
            <p className="text-sm cs-muted">
              Changes apply to new trials. Existing trials retain their original
              dates and limits. Expired trials fall back to Free. Existing
              content is retained when a user exceeds the new limit.
            </p>
        ...
        >
          ...
          <fieldset disabled={busy} className="grid sm:grid-cols-2 gap-3">
            ...
            <label className="grid gap-1">
              Display name
              <input name="name" className="cs-input" required maxLength={60} />
            </label>
            {[
          ...
          <form
            ...
            onSubmit={(e) => {
              ...
              void save({
                action: "account",
                target: a.id,
                body: { app_role: f.get("app_role"), status: f.get("status") },
              });
            }}
          >
